...
function shouldWidgetUpdate(node, prop, value) {
 ...
 * @param props
 */
export const CreateLayout = function (type, options, props = {}) {
 ...
 * @param props
 */
export const Button = function (text, props = {}) {
    const widget = new Widget();
 ...
 */
export const Image = function (src, props) {
    const widget = new Widget();
