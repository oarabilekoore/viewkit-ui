import type { Widget, WidgetOptions, LinkOptions } from "./types.js";
/**
 * Button Widget
 * @param {string} text
 ...
 * and your text.
 */
export declare const Link: (text: string | undefined, properties: LinkOptions) => Widget<HTMLAnchorElement>;
export {};
