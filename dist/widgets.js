...
class HtmlWidget {
    ...
    static Build(properties, tag) {
        return new HtmlWidget(properties, tag).element;
    }
}
/**
 ...
 */
export const Button = (text = "", properties) => {
    const button = HtmlWidget.Build(properties, "button");
 ...
 */
export const Image = (src, properties) => {
    const img = HtmlWidget.Build(properties, "img");
    img.src = src;
    return img;
};
/**
 ...
 */
export const Anchor = (text, properties) => {
    const link = HtmlWidget.Build(properties, "a");
 ...
 */
export const Heading = (text, level, properties) => {
    const heading = HtmlWidget.Build(properties, `h${level}`);
 ...
 */
export const Input = (type, properties) => {
    const input = HtmlWidget.Build(properties, "input");
    input.type = type;
    return input;
};
/**
 ...
 */
export const TextArea = (placeholder, properties) => {
    const textarea = HtmlWidget.Build(properties, "textarea");
 ...
 */
export const Video = (src, properties) => {
    const video = HtmlWidget.Build(properties, "video");
    video.src = src;
    return video;
};
/**
 ...
 */
export const Audio = (src, properties) => {
    const audio = HtmlWidget.Build(properties, "audio");
    audio.src = src;
    return audio;
};
/**
 ...
 */
export const IFrame = (src, properties) => {
    const iframe = HtmlWidget.Build(properties, "iframe");
    iframe.src = src;
    return iframe;
};
/**
...
export const Canvas = (properties) => {
    return HtmlWidget.Build(properties, "canvas");
};
/**
...
export const Hr = (properties) => {
    return HtmlWidget.Build(properties, "hr");
};
/**
...
export const Br = (properties) => {
    return HtmlWidget.Build(properties, "br");
};
/**
 ...
 */
export const Link = (text = "", properties) => {
    const { parent, to = "/", style = "", query = {}, behaveLikeLink = false } = properties;
    const link = HtmlWidget.Build({ parent, style }, "a");
    link.textContent = text;
    if (!behaveLikeLink) {
        link.onclick = () => {
            //@ts-ignore
